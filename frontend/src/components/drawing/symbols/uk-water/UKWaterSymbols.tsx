...
export const UKCentrifugalPump: React.FC<UKWaterSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 60 60">
    ...
    {/* Direction arrow */}
    <path
      d="M 15 30 L 45 30 M 38 25 L 45 30 L 38 35"
      stroke={color}
      strokeWidth={strokeWidth}
      fill="none"
    />
...
export const UKPressureReducingValve: React.FC<UKWaterSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 60 50">
    {/* PRV body */}
    <polygon
      points="20,15 40,15 45,25 40,35 20,35 15,25"
      stroke={color}
      strokeWidth={strokeWidth}
      fill={fillColor}
    />
    {/* Spring indicator */}
    <path
      d="M 25 20 Q 30 25 25 30 Q 30 25 35 30"
      stroke={color}
      strokeWidth={strokeWidth}
      fill="none"
    />
...
export const UKServiceReservoir: React.FC<UKWaterSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 80 60">
    {/* Covered reservoir */}
    <path
      d="M 10 40 L 10 50 L 70 50 L 70 40"
      stroke={color}
      strokeWidth={strokeWidth}
      fill={fillColor}
    />
...
export const UKChlorineDosing: React.FC<UKWaterSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 60 60">
    ...
    />
    {/* Chemical symbol */}
    <text x="30" y="28" textAnchor="middle" fontSize="12" fill={color}>
      Cl₂
    </text>
    {/* Dosing pump */}
...
export const UKUVDisinfection: React.FC<UKWaterSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 70 50">
    ...
    {/* UV rays */}
    <path
      d="M 25 25 L 20 22 M 25 25 L 20 28 M 35 25 L 30 22 M 35 25 L 30 28"
      stroke={color}
      strokeWidth={0.5}
      opacity="0.5"
    />
...
export const UKFlowMeter: React.FC<UKWaterSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 50 50">
    ...
    <text x="25" y="28" textAnchor="middle" fontSize="8" fill={color}>
      m³/h
    </text>
    {/* Flow lines */}
...
export const UKBoosterSet: React.FC<UKWaterSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 80 60">
    ...
    <rect
      ...
      fill={fillColor}
    />
    <text x="45" y="10" textAnchor="middle" fontSize="6" fill={color}>
      VSD
    </text>
  </svg>
);
