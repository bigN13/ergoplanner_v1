...
export const ISO_ScrewPump: React.FC<ISOSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M 20 25 Q 25 30 30 25 Q 35 20 40 25 Q 45 30 40 35 Q 35 40 30 35 Q 25 30 20 35"
...
export const ISO_ShutoffValve: React.FC<ISOSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="20" y="20" width="20" height="20" stroke={color} strokeWidth={strokeWidth} fill={fillColor} />
...
export const ISO_ControlValve: React.FC<ISOSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M 20 30 L 30 20 L 30 40 Z M 40 30 L 30 20 L 30 40 Z"
          fill={fillColor} stroke={color} strokeWidth={strokeWidth} />
    <rect x="25" y="5" width="10" height="15" stroke={color} strokeWidth={strokeWidth} fill={fillColor} />
    <line x1="30" y1="5" x2="30" y2="20" stroke={color} strokeWidth={strokeWidth} strokeDasharray="2 2" />
    <line x1="5" y1="30" x2="20" y2="30" stroke={color} strokeWidth={strokeWidth} />
    <line x1="40" y1="30" x2="55" y2="30" stroke={color} strokeWidth={strokeWidth} />
  </svg>
);
...
export const ISO_PressureVessel: React.FC<ISOSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 60 80" fill="none" xmlns="http://www.w3.org/2000/svg">
    <ellipse cx="30" cy="20" rx="18" ry="8" stroke={color} strokeWidth={strokeWidth} fill={fillColor} />
    ...
    <ellipse cx="30" cy="60" rx="18" ry="8" stroke={color} strokeWidth={strokeWidth} fill={fillColor} />
  </svg>
);
...
export const ISO_StorageTank: React.FC<ISOSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="10" y="15" width="40" height="35" stroke={color} strokeWidth={strokeWidth} fill={fillColor} />
...
export const ISO_OpenTank: React.FC<ISOSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M 10 15 L 10 50 L 50 50 L 50 15"
          stroke={color} strokeWidth={strokeWidth} fill="none" />
    <rect x="12" y="35" width="36" height="13" fill="#E0E7FF" opacity="0.5" />
  </svg>
);
...
export const ISO_Condenser: React.FC<ISOSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 80 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="15" y="15" width="50" height="30" stroke={color} strokeWidth={strokeWidth} fill={fillColor} />
    <path d="M 20 20 L 60 20 M 20 25 L 60 25 M 20 30 L 60 30 M 20 35 L 60 35 M 20 40 L 60 40"
...
export const ISO_TemperatureSensor: React.FC<ISOSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="25" y="15" width="10" height="25" stroke={color} strokeWidth={strokeWidth} fill={fillColor} />
...
export const ISO_LevelGauge: React.FC<ISOSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="20" y="10" width="20" height="40" stroke={color} strokeWidth={strokeWidth} fill={fillColor} />
...
export const ISO_Filter: React.FC<ISOSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="20" y="15" width="20" height="30" stroke={color} strokeWidth={strokeWidth} fill={fillColor} />
...
export const ISO_Separator: React.FC<ISOSymbolProps> = ({
  ...
  <svg width={width} height={height} viewBox="0 0 60 80" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M 10 20 L 10 60 Q 10 70 30 70 Q 50 70 50 60 L 50 20 Q 50 10 30 10 Q 10 10 10 20"
          stroke={color} strokeWidth={strokeWidth} fill={fillColor} />
    <line x1="10" y1="40" x2="50" y2="40" stroke={color} strokeWidth={strokeWidth} strokeDasharray="3 3" />
